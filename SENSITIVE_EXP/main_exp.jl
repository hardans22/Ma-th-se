...
time_limit = 1800
FH = false
FC, tk_option = true, "MIN"
DY, fd_option = true, "MIN"
MTN_CAP = false
#model_amrp(file*".json")
fold_1 = "RESULTS/A_MTN_2/"
fold_2 = ""
#= if FH && FC && tk_option == "MIN" 
    fold_2 = "FH_FC_MIN/"
elseif FH && FC && tk_option == "MAX" 
    fold_2 = "FH_FC_MAX/"
elseif FH && FC && tk_option == "MEDIAN" 
    fold_2 = "FH_FC_MEDIAN/"
elseif FH && FC && tk_option == "MEAN" 
    fold_2 = "FH_FC_MEAN/"
elseif FH && DY && fd_option == "MIN" 
    fold_2 = "FH_DY_MIN/"
elseif FH && DY && fd_option == "MAX" 
    fold_2 = "FH_DY_MAX/"
elseif FH && DY && fd_option == "MEDIAN" 
    fold_2 = "FH_DY_MEDIAN/"
elseif FH && DY && fd_option == "MEAN" 
    fold_2 = "FH_DY_MEAN/"
end
 =#

if tk_option == "MIN" && fd_option == "MIN" 
    fold_2 = "FC_MIN_DY_MIN/"
elseif tk_option == "MIN" && fd_option == "MAX" 
    fold_2 = "FC_MIN_DY_MAX/"
elseif tk_option == "MAX" && fd_option == "MIN" 
    fold_2 = "FC_MAX_DY_MIN/"
elseif tk_option == "MAX" && fd_option == "MAX"
    fold_2 = "FC_MAX_DY_MAX/"
end
...
for preprocess in [false]
    ...
    for v in 1:1
        ...
        close(Output_file)
        solution = model_amrp(env, inst_path*".json", path_file, nbr_thread, silent, preprocess, time_limit, FH, FC, DY, MTN_CAP, tk_option,fd_option)
        Output_file = open(path_file, "a") 
        println("AVANT PREPROCESSING")
    ...
    #= xlsx_path = Outputs_fold * "RESULTS_" * instance * ".xlsx"
    XLSX.openxlsx(xlsx_path, mode="w") do xf
        
        XLSX.rename!(xf["Sheet1"], "Summary")
        summary_sheet = xf["Summary"]
        
        XLSX.writetable!(summary_sheet, Tables.columntable(dataframe); write_columnnames = true)

        ac_sheet = XLSX.addsheet!(xf, "Aircrafts") 
        XLSX.writetable!(ac_sheet, Tables.columntable(dataframe2); write_columnnames = true)
