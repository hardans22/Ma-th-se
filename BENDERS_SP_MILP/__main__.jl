...
for v in 11:20
    ...
    write_both(Output_file, "Temps total du master: $(round(solution["mp_time"], digits=4))s")
    write_both(Output_file, "Temps total du sp: $(round(solution["sp_time"], digits=4))s") 
